...
uses
  ...
  u_framework_components, U_DBListView, U_ExtNumEdits, 
  u_regframeworkcomponents, U_ExtDBNavigator, U_FormMainIni, U_ExtDBImage, 
  u_framework_dbcomponents, u_extsearchedit, U_ExtComboInsert, u_extdbgrid, 
  u_extmenutoolbar, U_CustomizeMenu, u_extmenucustomize, LazarusPackageIntf;
